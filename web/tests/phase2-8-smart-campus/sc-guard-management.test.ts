...
import { ScGuardManagementService } from '@/features/smart-campus/services/scguardmanagementservice.service';

describe('ScGuardManagementService', () => {
  let service: ScGuardManagementService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScGuardManagementService(mockSupabase);
  });

  describe('assignGuard', () => {
    it('should assignGuard successfully', async () => {
      const result = await service.assignGuard('guard-1', 'zone-1');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.assignGuard('guard-1', 'zone-1');
      const promise2 = service.assignGuard('guard-1', 'zone-1');
