...
import { ScAnalyticsEngineService } from '@/features/smart-campus/services/scanalyticsengineservice.service';

describe('ScAnalyticsEngineService', () => {
  let service: ScAnalyticsEngineService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScAnalyticsEngineService(mockSupabase);
  });

  describe('runAnalytics', () => {
    it('should runAnalytics successfully', async () => {
      const result = await service.runAnalytics('school-1', 'engagement');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.runAnalytics('school-1', 'engagement');
      const promise2 = service.runAnalytics('school-1', 'engagement');
