...
import { ScCarbonManagementService } from '@/features/smart-campus/services/sccarbonmanagementservice.service';

describe('ScCarbonManagementService', () => {
  let service: ScCarbonManagementService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScCarbonManagementService(mockSupabase);
  });

  describe('trackCarbonEmissions', () => {
    it('should trackCarbonEmissions successfully', async () => {
      const result = await service.trackCarbonEmissions('school-1');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.trackCarbonEmissions('school-1');
      const promise2 = service.trackCarbonEmissions('school-1');
