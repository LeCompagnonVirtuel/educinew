...
import { ScAuditService } from '@/features/smart-campus/services/scauditservice.service';

describe('ScAuditService', () => {
  let service: ScAuditService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScAuditService(mockSupabase);
  });

  describe('logAction', () => {
    it('should logAction successfully', async () => {
      const result = await service.logAction('user-1', 'create', 'resource-1');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.logAction('user-1', 'create', 'resource-1');
      const promise2 = service.logAction('user-1', 'create', 'resource-1');
