...
import { ScUnsubscribeService } from '@/features/smart-campus/services/scunsubscribeservice.service';

describe('ScUnsubscribeService', () => {
  let service: ScUnsubscribeService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScUnsubscribeService(mockSupabase);
  });

  describe('unsubscribe', () => {
    it('should unsubscribe successfully', async () => {
      const result = await service.unsubscribe('user-1', 'channel-1');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.unsubscribe('user-1', 'channel-1');
      const promise2 = service.unsubscribe('user-1', 'channel-1');
