...
import { ScCurrencyService } from '@/features/smart-campus/services/sccurrencyservice.service';

describe('ScCurrencyService', () => {
  let service: ScCurrencyService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScCurrencyService(mockSupabase);
  });

  describe('setCurrency', () => {
    it('should setCurrency successfully', async () => {
      const result = await service.setCurrency('user-1', 'USD');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.setCurrency('user-1', 'USD');
      const promise2 = service.setCurrency('user-1', 'USD');
