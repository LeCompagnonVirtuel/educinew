...
import { ScFlagService } from '@/features/smart-campus/services/scflagservice.service';

describe('ScFlagService', () => {
  let service: ScFlagService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScFlagService(mockSupabase);
  });

  describe('flag', () => {
    it('should flag successfully', async () => {
      const result = await service.flag('user-1', 'resource-1');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.flag('user-1', 'resource-1');
      const promise2 = service.flag('user-1', 'resource-1');
