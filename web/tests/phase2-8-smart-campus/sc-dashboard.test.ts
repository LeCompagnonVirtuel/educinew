...
import { ScDashboardService } from '@/features/smart-campus/services/scdashboardservice.service';

describe('ScDashboardService', () => {
  let service: ScDashboardService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScDashboardService(mockSupabase);
  });

  describe('getDashboardData', () => {
    it('should getDashboardData successfully', async () => {
      const result = await service.getDashboardData('school-1');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.getDashboardData('school-1');
      const promise2 = service.getDashboardData('school-1');
