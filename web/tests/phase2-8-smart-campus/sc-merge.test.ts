...
import { ScMergeService } from '@/features/smart-campus/services/scmergeservice.service';

describe('ScMergeService', () => {
  let service: ScMergeService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScMergeService(mockSupabase);
  });

  describe('merge', () => {
    it('should merge successfully', async () => {
      const result = await service.merge('resource-1', 'branch-1', 'branch-2');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.merge('resource-1', 'branch-1', 'branch-2');
      const promise2 = service.merge('resource-1', 'branch-1', 'branch-2');
