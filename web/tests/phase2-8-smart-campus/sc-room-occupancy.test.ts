...
import { ScRoomOccupancyService } from '@/features/smart-campus/services/scroomoccupancyservice.service';

describe('ScRoomOccupancyService', () => {
  let service: ScRoomOccupancyService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScRoomOccupancyService(mockSupabase);
  });

  describe('getOccupancy', () => {
    it('should getOccupancy successfully', async () => {
      const result = await service.getOccupancy('room-1');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.getOccupancy('room-1');
      const promise2 = service.getOccupancy('room-1');
