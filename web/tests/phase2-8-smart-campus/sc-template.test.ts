...
import { ScTemplateService } from '@/features/smart-campus/services/sctemplateservice.service';

describe('ScTemplateService', () => {
  let service: ScTemplateService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScTemplateService(mockSupabase);
  });

  describe('createTemplate', () => {
    it('should createTemplate successfully', async () => {
      const result = await service.createTemplate('school-1', { name: 'Template 1', content: 'test' });
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.createTemplate('school-1', { name: 'Template 1', content: 'test' });
      const promise2 = service.createTemplate('school-1', { name: 'Template 1', content: 'test' });
