...
import { ScJobService } from '@/features/smart-campus/services/scjobservice.service';

describe('ScJobService', () => {
  let service: ScJobService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScJobService(mockSupabase);
  });

  describe('createJob', () => {
    it('should createJob successfully', async () => {
      const result = await service.createJob('school-1', { type: 'report', params: {} });
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.createJob('school-1', { type: 'report', params: {} });
      const promise2 = service.createJob('school-1', { type: 'report', params: {} });
