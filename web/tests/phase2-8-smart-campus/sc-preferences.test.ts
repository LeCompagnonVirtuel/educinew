...
import { ScPreferencesService } from '@/features/smart-campus/services/scpreferencesservice.service';

describe('ScPreferencesService', () => {
  let service: ScPreferencesService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScPreferencesService(mockSupabase);
  });

  describe('getPreferences', () => {
    it('should getPreferences successfully', async () => {
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.getPreferences('user-1');
      const promise2 = service.getPreferences('user-1');
