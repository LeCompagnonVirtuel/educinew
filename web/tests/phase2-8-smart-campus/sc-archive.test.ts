...
import { ScArchiveService } from '@/features/smart-campus/services/scarchiveservice.service';

describe('ScArchiveService', () => {
  let service: ScArchiveService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScArchiveService(mockSupabase);
  });

  describe('archive', () => {
    it('should archive successfully', async () => {
      const result = await service.archive('user-1', 'resource-1');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.archive('user-1', 'resource-1');
      const promise2 = service.archive('user-1', 'resource-1');
