...
import { ScWaterManagementService } from '@/features/smart-campus/services/scwatermanagementservice.service';

describe('ScWaterManagementService', () => {
  let service: ScWaterManagementService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScWaterManagementService(mockSupabase);
  });

  describe('monitorWaterUsage', () => {
    it('should monitorWaterUsage successfully', async () => {
      const result = await service.monitorWaterUsage('building-1');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.monitorWaterUsage('building-1');
      const promise2 = service.monitorWaterUsage('building-1');
