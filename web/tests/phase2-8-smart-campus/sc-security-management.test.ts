...
import { ScSecurityManagementService } from '@/features/smart-campus/services/scsecuritymanagementservice.service';

describe('ScSecurityManagementService', () => {
  let service: ScSecurityManagementService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScSecurityManagementService(mockSupabase);
  });

  describe('createIncident', () => {
    it('should createIncident successfully', async () => {
      const result = await service.createIncident('school-1', { type: 'theft', location: 'Building A' });
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.createIncident('school-1', { type: 'theft', location: 'Building A' });
      const promise2 = service.createIncident('school-1', { type: 'theft', location: 'Building A' });
