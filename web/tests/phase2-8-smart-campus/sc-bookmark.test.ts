...
import { ScBookmarkService } from '@/features/smart-campus/services/scbookmarkservice.service';

describe('ScBookmarkService', () => {
  let service: ScBookmarkService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScBookmarkService(mockSupabase);
  });

  describe('addBookmark', () => {
    it('should addBookmark successfully', async () => {
      const result = await service.addBookmark('user-1', 'resource-1');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.addBookmark('user-1', 'resource-1');
      const promise2 = service.addBookmark('user-1', 'resource-1');
