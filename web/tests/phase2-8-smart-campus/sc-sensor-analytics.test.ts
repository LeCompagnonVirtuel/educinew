...
import { ScSensorAnalyticsService } from '@/features/smart-campus/services/scsensoranalyticsservice.service';

describe('ScSensorAnalyticsService', () => {
  let service: ScSensorAnalyticsService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScSensorAnalyticsService(mockSupabase);
  });

  describe('analyzeSensorData', () => {
    it('should analyzeSensorData successfully', async () => {
      const result = await service.analyzeSensorData('sensor-1', '2024-01-01', '2024-01-31');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.analyzeSensorData('sensor-1', '2024-01-01', '2024-01-31');
      const promise2 = service.analyzeSensorData('sensor-1', '2024-01-01', '2024-01-31');
