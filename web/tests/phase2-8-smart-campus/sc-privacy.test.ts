...
import { ScPrivacyService } from '@/features/smart-campus/services/scprivacyservice.service';

describe('ScPrivacyService', () => {
  let service: ScPrivacyService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScPrivacyService(mockSupabase);
  });

  describe('getPrivacySettings', () => {
    it('should getPrivacySettings successfully', async () => {
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.getPrivacySettings('user-1');
      const promise2 = service.getPrivacySettings('user-1');
