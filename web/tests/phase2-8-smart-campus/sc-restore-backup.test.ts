...
import { ScRestoreBackupService } from '@/features/smart-campus/services/screstorebackupservice.service';

describe('ScRestoreBackupService', () => {
  let service: ScRestoreBackupService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScRestoreBackupService(mockSupabase);
  });

  describe('restoreBackup', () => {
    it('should restoreBackup successfully', async () => {
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.restoreBackup('backup-1');
      const promise2 = service.restoreBackup('backup-1');
