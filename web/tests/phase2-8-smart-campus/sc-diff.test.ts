...
import { ScDiffService } from '@/features/smart-campus/services/scdiffservice.service';

describe('ScDiffService', () => {
  let service: ScDiffService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScDiffService(mockSupabase);
  });

  describe('compareVersions', () => {
    it('should compareVersions successfully', async () => {
      const result = await service.compareVersions('resource-1', 'v1', 'v2');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.compareVersions('resource-1', 'v1', 'v2');
      const promise2 = service.compareVersions('resource-1', 'v1', 'v2');
