...
import { ScMigrateService } from '@/features/smart-campus/services/scmigrateservice.service';

describe('ScMigrateService', () => {
  let service: ScMigrateService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScMigrateService(mockSupabase);
  });

  describe('migrate', () => {
    it('should migrate successfully', async () => {
      const result = await service.migrate('school-1', 'v1', 'v2');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.migrate('school-1', 'v1', 'v2');
      const promise2 = service.migrate('school-1', 'v1', 'v2');
