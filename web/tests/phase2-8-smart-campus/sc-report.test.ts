...
import { ScReportService } from '@/features/smart-campus/services/screportservice.service';

describe('ScReportService', () => {
  let service: ScReportService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScReportService(mockSupabase);
  });

  describe('generateReport', () => {
    it('should generateReport successfully', async () => {
      const result = await service.generateReport('school-1', 'daily');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.generateReport('school-1', 'daily');
      const promise2 = service.generateReport('school-1', 'daily');
