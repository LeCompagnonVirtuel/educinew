...
import { ScEnergyManagementService } from '@/features/smart-campus/services/scenergymanagementservice.service';

describe('ScEnergyManagementService', () => {
  let service: ScEnergyManagementService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScEnergyManagementService(mockSupabase);
  });

  describe('monitorEnergyUsage', () => {
    it('should monitorEnergyUsage successfully', async () => {
      const result = await service.monitorEnergyUsage('building-1');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.monitorEnergyUsage('building-1');
      const promise2 = service.monitorEnergyUsage('building-1');
