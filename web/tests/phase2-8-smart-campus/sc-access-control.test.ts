...
import { ScAccessControlService } from '@/features/smart-campus/services/scaccesscontrolservice.service';

describe('ScAccessControlService', () => {
  let service: ScAccessControlService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScAccessControlService(mockSupabase);
  });

  describe('grantAccess', () => {
    it('should grantAccess successfully', async () => {
      const result = await service.grantAccess('user-1', 'zone-1');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.grantAccess('user-1', 'zone-1');
      const promise2 = service.grantAccess('user-1', 'zone-1');
