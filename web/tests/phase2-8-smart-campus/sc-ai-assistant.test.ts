...
import { ScAiAssistantService } from '@/features/smart-campus/services/scaiassistantservice.service';

describe('ScAiAssistantService', () => {
  let service: ScAiAssistantService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScAiAssistantService(mockSupabase);
  });

  describe('getRecommendation', () => {
    it('should getRecommendation successfully', async () => {
      const result = await service.getRecommendation('user-1', 'study-plan');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.getRecommendation('user-1', 'study-plan');
      const promise2 = service.getRecommendation('user-1', 'study-plan');
