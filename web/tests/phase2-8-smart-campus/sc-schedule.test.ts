...
import { ScScheduleService } from '@/features/smart-campus/services/scscheduleservice.service';

describe('ScScheduleService', () => {
  let service: ScScheduleService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScScheduleService(mockSupabase);
  });

  describe('schedule', () => {
    it('should schedule successfully', async () => {
      const result = await service.schedule('resource-1', '2024-01-15T10:00:00Z');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.schedule('resource-1', '2024-01-15T10:00:00Z');
      const promise2 = service.schedule('resource-1', '2024-01-15T10:00:00Z');
