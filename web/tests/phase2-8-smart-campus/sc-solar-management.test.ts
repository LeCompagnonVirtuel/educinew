...
import { ScSolarManagementService } from '@/features/smart-campus/services/scsolarmanagementservice.service';

describe('ScSolarManagementService', () => {
  let service: ScSolarManagementService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScSolarManagementService(mockSupabase);
  });

  describe('monitorSolarPanels', () => {
    it('should monitorSolarPanels successfully', async () => {
      const result = await service.monitorSolarPanels('building-1');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.monitorSolarPanels('building-1');
      const promise2 = service.monitorSolarPanels('building-1');
