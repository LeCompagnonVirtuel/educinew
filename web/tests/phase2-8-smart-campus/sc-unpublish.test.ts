...
import { ScUnpublishService } from '@/features/smart-campus/services/scunpublishservice.service';

describe('ScUnpublishService', () => {
  let service: ScUnpublishService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScUnpublishService(mockSupabase);
  });

  describe('unpublish', () => {
    it('should unpublish successfully', async () => {
      const result = await service.unpublish('user-1', 'resource-1');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.unpublish('user-1', 'resource-1');
      const promise2 = service.unpublish('user-1', 'resource-1');
