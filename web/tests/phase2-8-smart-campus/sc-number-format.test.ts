...
import { ScNumberFormatService } from '@/features/smart-campus/services/scnumberformatservice.service';

describe('ScNumberFormatService', () => {
  let service: ScNumberFormatService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScNumberFormatService(mockSupabase);
  });

  describe('setNumberFormat', () => {
    it('should setNumberFormat successfully', async () => {
      const result = await service.setNumberFormat('user-1', 'en-US');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.setNumberFormat('user-1', 'en-US');
      const promise2 = service.setNumberFormat('user-1', 'en-US');
