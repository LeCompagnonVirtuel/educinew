...
import { ScDateFormatService } from '@/features/smart-campus/services/scdateformatservice.service';

describe('ScDateFormatService', () => {
  let service: ScDateFormatService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScDateFormatService(mockSupabase);
  });

  describe('setDateFormat', () => {
    it('should setDateFormat successfully', async () => {
      const result = await service.setDateFormat('user-1', 'MM/DD/YYYY');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.setDateFormat('user-1', 'MM/DD/YYYY');
      const promise2 = service.setDateFormat('user-1', 'MM/DD/YYYY');
