...
import { ScVersionService } from '@/features/smart-campus/services/scversionservice.service';

describe('ScVersionService', () => {
  let service: ScVersionService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScVersionService(mockSupabase);
  });

  describe('createVersion', () => {
    it('should createVersion successfully', async () => {
      const result = await service.createVersion('resource-1', { data: 'test' });
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.createVersion('resource-1', { data: 'test' });
      const promise2 = service.createVersion('resource-1', { data: 'test' });
