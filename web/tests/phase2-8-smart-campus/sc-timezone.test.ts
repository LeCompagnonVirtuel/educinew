...
import { ScTimezoneService } from '@/features/smart-campus/services/sctimezoneservice.service';

describe('ScTimezoneService', () => {
  let service: ScTimezoneService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScTimezoneService(mockSupabase);
  });

  describe('setTimezone', () => {
    it('should setTimezone successfully', async () => {
      const result = await service.setTimezone('user-1', 'America/New_York');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.setTimezone('user-1', 'America/New_York');
      const promise2 = service.setTimezone('user-1', 'America/New_York');
