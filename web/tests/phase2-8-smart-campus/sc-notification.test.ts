...
import { ScNotificationService } from '@/features/smart-campus/services/scnotificationservice.service';

describe('ScNotificationService', () => {
  let service: ScNotificationService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScNotificationService(mockSupabase);
  });

  describe('sendNotification', () => {
    it('should sendNotification successfully', async () => {
      const result = await service.sendNotification('user-1', 'Test notification');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.sendNotification('user-1', 'Test notification');
      const promise2 = service.sendNotification('user-1', 'Test notification');
