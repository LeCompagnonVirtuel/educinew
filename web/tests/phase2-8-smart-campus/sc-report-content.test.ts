...
import { ScReportContentService } from '@/features/smart-campus/services/screportcontentservice.service';

describe('ScReportContentService', () => {
  let service: ScReportContentService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScReportContentService(mockSupabase);
  });

  describe('reportContent', () => {
    it('should reportContent successfully', async () => {
      const result = await service.reportContent('user-1', 'resource-1', 'spam');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.reportContent('user-1', 'resource-1', 'spam');
      const promise2 = service.reportContent('user-1', 'resource-1', 'spam');
