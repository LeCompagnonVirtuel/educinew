...
import { ScPushNotificationService } from '@/features/smart-campus/services/scpushnotificationservice.service';

describe('ScPushNotificationService', () => {
  let service: ScPushNotificationService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScPushNotificationService(mockSupabase);
  });

  describe('sendPushNotification', () => {
    it('should sendPushNotification successfully', async () => {
      const result = await service.sendPushNotification('user-1', { title: 'Test', body: 'Message' });
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.sendPushNotification('user-1', { title: 'Test', body: 'Message' });
      const promise2 = service.sendPushNotification('user-1', { title: 'Test', body: 'Message' });
