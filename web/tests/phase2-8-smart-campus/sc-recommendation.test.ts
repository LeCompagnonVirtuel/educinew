...
import { ScRecommendationService } from '@/features/smart-campus/services/screcommendationservice.service';

describe('ScRecommendationService', () => {
  let service: ScRecommendationService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScRecommendationService(mockSupabase);
  });

  describe('getRecommendations', () => {
    it('should getRecommendations successfully', async () => {
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.getRecommendations('user-1');
      const promise2 = service.getRecommendations('user-1');
