...
import { ScMaintenanceSchedulingService } from '@/features/smart-campus/services/scmaintenanceschedulingservice.service';

describe('ScMaintenanceSchedulingService', () => {
  let service: ScMaintenanceSchedulingService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScMaintenanceSchedulingService(mockSupabase);
  });

  describe('scheduleMaintenance', () => {
    it('should scheduleMaintenance successfully', async () => {
      const result = await service.scheduleMaintenance('asset-1', '2024-01-15T10:00:00Z');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.scheduleMaintenance('asset-1', '2024-01-15T10:00:00Z');
      const promise2 = service.scheduleMaintenance('asset-1', '2024-01-15T10:00:00Z');
