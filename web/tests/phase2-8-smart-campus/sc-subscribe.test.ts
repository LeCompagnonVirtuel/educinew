...
import { ScSubscribeService } from '@/features/smart-campus/services/scsubscribeservice.service';

describe('ScSubscribeService', () => {
  let service: ScSubscribeService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScSubscribeService(mockSupabase);
  });

  describe('subscribe', () => {
    it('should subscribe successfully', async () => {
      const result = await service.subscribe('user-1', 'channel-1');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.subscribe('user-1', 'channel-1');
      const promise2 = service.subscribe('user-1', 'channel-1');
