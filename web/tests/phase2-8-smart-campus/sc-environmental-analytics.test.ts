...
import { ScEnvironmentalAnalyticsService } from '@/features/smart-campus/services/scenvironmentalanalyticsservice.service';

describe('ScEnvironmentalAnalyticsService', () => {
  let service: ScEnvironmentalAnalyticsService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScEnvironmentalAnalyticsService(mockSupabase);
  });

  describe('analyzeEnvironment', () => {
    it('should analyzeEnvironment successfully', async () => {
      const result = await service.analyzeEnvironment('school-1', '2024-01-01', '2024-01-31');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.analyzeEnvironment('school-1', '2024-01-01', '2024-01-31');
      const promise2 = service.analyzeEnvironment('school-1', '2024-01-01', '2024-01-31');
