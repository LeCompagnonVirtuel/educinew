...
import { ScCommentService } from '@/features/smart-campus/services/sccommentservice.service';

describe('ScCommentService', () => {
  let service: ScCommentService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScCommentService(mockSupabase);
  });

  describe('addComment', () => {
    it('should addComment successfully', async () => {
      const result = await service.addComment('user-1', 'resource-1', 'Great!');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.addComment('user-1', 'resource-1', 'Great!');
      const promise2 = service.addComment('user-1', 'resource-1', 'Great!');
