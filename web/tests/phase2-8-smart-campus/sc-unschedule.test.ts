...
import { ScUnscheduleService } from '@/features/smart-campus/services/scunscheduleservice.service';

describe('ScUnscheduleService', () => {
  let service: ScUnscheduleService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScUnscheduleService(mockSupabase);
  });

  describe('unschedule', () => {
    it('should unschedule successfully', async () => {
      const result = await service.unschedule('resource-1');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.unschedule('resource-1');
      const promise2 = service.unschedule('resource-1');
