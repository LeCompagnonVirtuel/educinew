...
import { ScIntegrationService } from '@/features/smart-campus/services/scintegrationservice.service';

describe('ScIntegrationService', () => {
  let service: ScIntegrationService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScIntegrationService(mockSupabase);
  });

  describe('connectService', () => {
    it('should connectService successfully', async () => {
      const result = await service.connectService('school-1', 'google-calendar');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.connectService('school-1', 'google-calendar');
      const promise2 = service.connectService('school-1', 'google-calendar');
