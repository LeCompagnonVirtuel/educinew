...
import { ScPermissionService } from '@/features/smart-campus/services/scpermissionservice.service';

describe('ScPermissionService', () => {
  let service: ScPermissionService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScPermissionService(mockSupabase);
  });

  describe('checkPermission', () => {
    it('should checkPermission successfully', async () => {
      const result = await service.checkPermission('user-1', 'read', 'resource-1');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.checkPermission('user-1', 'read', 'resource-1');
      const promise2 = service.checkPermission('user-1', 'read', 'resource-1');
