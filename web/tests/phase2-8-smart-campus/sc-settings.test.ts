...
import { ScSettingsService } from '@/features/smart-campus/services/scsettingsservice.service';

describe('ScSettingsService', () => {
  let service: ScSettingsService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScSettingsService(mockSupabase);
  });

  describe('getSettings', () => {
    it('should getSettings successfully', async () => {
      const result = await service.getSettings('school-1');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.getSettings('school-1');
      const promise2 = service.getSettings('school-1');
