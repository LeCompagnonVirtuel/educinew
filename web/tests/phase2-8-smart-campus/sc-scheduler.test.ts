...
import { ScSchedulerService } from '@/features/smart-campus/services/scschedulerservice.service';

describe('ScSchedulerService', () => {
  let service: ScSchedulerService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScSchedulerService(mockSupabase);
  });

  describe('scheduleTask', () => {
    it('should scheduleTask successfully', async () => {
      const result = await service.scheduleTask('task-1', '2024-01-15T10:00:00Z');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.scheduleTask('task-1', '2024-01-15T10:00:00Z');
      const promise2 = service.scheduleTask('task-1', '2024-01-15T10:00:00Z');
