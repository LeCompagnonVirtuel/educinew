...
import { ScCronService } from '@/features/smart-campus/services/sccronservice.service';

describe('ScCronService', () => {
  let service: ScCronService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScCronService(mockSupabase);
  });

  describe('createCronJob', () => {
    it('should createCronJob successfully', async () => {
      const result = await service.createCronJob('school-1', '0 9 * * *', 'daily-report');
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.createCronJob('school-1', '0 9 * * *', 'daily-report');
      const promise2 = service.createCronJob('school-1', '0 9 * * *', 'daily-report');
