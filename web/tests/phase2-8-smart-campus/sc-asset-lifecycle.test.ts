...
import { ScAssetLifecycleService } from '@/features/smart-campus/services/scassetlifecycleservice.service';

describe('ScAssetLifecycleService', () => {
  let service: ScAssetLifecycleService;
  const mockSupabase = {
    from: vi.fn(() => ({
      select: vi.fn(() => ({
        eq: vi.fn(() => ({
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new ScAssetLifecycleService(mockSupabase);
  });

  describe('createAsset', () => {
    it('should createAsset successfully', async () => {
      const result = await service.createAsset('school-1', { name: 'Laptop', type: 'IT' });
    ...
    it('should handle concurrent requests', async () => {
      const promise1 = service.createAsset('school-1', { name: 'Laptop', type: 'IT' });
      const promise2 = service.createAsset('school-1', { name: 'Laptop', type: 'IT' });
