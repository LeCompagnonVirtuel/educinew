...
export const CreateEmploymentSchema = z.object({
  ...
  contract_type: z.enum(["permanent", "temporary", "probation", "freelance", "internship", "consulting"], { message: "Type de contrat invalide" }),
  ...
  status: z.enum(["active", "on_leave", "suspended", "terminated", "resigned", "retired"], { message: "Statut invalide" }).default("active"),
...
export const UpdateEmploymentSchema = z.object({
  ...
  contract_type: z.enum(["permanent", "temporary", "probation", "freelance", "internship", "consulting"], { message: "Type de contrat invalide" }).optional(),
  ...
  status: z.enum(["active", "on_leave", "suspended", "terminated", "resigned", "retired"], { message: "Statut invalide" }).optional(),
