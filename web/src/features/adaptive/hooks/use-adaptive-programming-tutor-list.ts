...
import type { ProgrammingTutor } from '@educi/types';

export const useAdaptiveProgrammingTutorList = (schoolId: string) => {
  const [items, setItems] = useState<ProgrammingTutor[]>([]);
