// Government & National Governance Service - RegionalDirectorate
...
export class GovRegionalDirectorateService {
  ...
  async getRegionalDirectorate(schoolId: string, id: string): Promise<RegionalDirectorate> {
  ...
  async listRegionalDirectorates(schoolId: string, filters?: Record<string, unknown>): Promise<RegionalDirectorate[]> {
    return this.repo.findAllRegionalDirectorates(schoolId, filters);
  }

  async createRegionalDirectorate(schoolId: string, data: RegionalDirectorateCreate): Promise<RegionalDirectorate> {
    return this.repo.createRegionalDirectorate(schoolId, data);
  }

  async updateRegionalDirectorate(schoolId: string, id: string, data: Partial<RegionalDirectorateCreate>): Promise<RegionalDirectorate> {
  ...
  async countRegionalDirectorates(schoolId: string, filters?: Record<string, unknown>): Promise<number> {
    return this.repo.countRegionalDirectorates(schoolId, filters);
  }
}
