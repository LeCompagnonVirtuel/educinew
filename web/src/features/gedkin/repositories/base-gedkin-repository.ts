...
import { NotFoundError } from '@educi/errors';

// ============================================================================
// Base Entity & Types
// ============================================================================

export interface GedkinBaseEntity {
  id: string;
  school_id: string;
  created_at: string;
  updated_at: string;
...
export class GedkinCrudRepositoryImpl<T extends GedkinBaseEntity>
  implements GedkinCrudRepository<T>
{
  constructor(
...
export function createGedkinCrudRepository<T extends GedkinBaseEntity>(
  supabase: SupabaseClient,
  tableName: string,
): GedkinCrudRepository<T> {
  return new GedkinCrudRepositoryImpl<T>(supabase, tableName);
}