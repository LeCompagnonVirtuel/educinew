...
import type {
  ...
  PaginationParams,
  FilterParams,
} from '../repositories/base-gedkin-repository';
import type { GedkinCrudRepository } from '../repositories/base-gedkin-repository';

// ============================================================================
// Base Service Configuration
// ============================================================================

export interface GedkinServiceConfig {
  enableAuditLog?: boolean;
  enableValidation?: boolean;
  maxPageSize?: number;
}

const DEFAULT_CONFIG: GedkinServiceConfig = {
  enableAuditLog: true,
...
export abstract class BaseGedkinService {
  ...
  protected async ensureExists<T extends GedkinBaseEntity>(
    repo: GedkinCrudRepository<T>,
    id: string,
    schoolId: string,
    entityName: string,
  ): Promise<T> {
  ...
  protected validateOwnership<T extends GedkinBaseEntity>(
    entity: T,
    schoolId: string,
    entityName: string,
  ): void {
...
export function createGedkinService<T extends BaseGedkinService>(
  ServiceClass: new (config?: GedkinServiceConfig) => T,
