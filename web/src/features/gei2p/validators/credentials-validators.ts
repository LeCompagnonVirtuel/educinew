...
export const CreateDigitalCredentialSchema = z.object({
  ...
  identity_id: z.string().uuid({ message: "Identifiant de l'identité invalide" }),
  credential_type: z.enum(["diploma", "certificate", "badge", "transcript", "license", "portfolio", "skill", "attendance", "award", "other"], { message: "Type de credential invalide" }),
...
export const UpdateDigitalCredentialSchema = z.object({
  credential_type: z.enum(["diploma", "certificate", "badge", "transcript", "license", "portfolio", "skill", "attendance", "award", "other"], { message: "Type de credential invalide" }).optional(),
