...
export const CreateSkillsExchangeSchema = z.object({
  ...
  evidence_type: z.enum(["certificate", "portfolio", "assessment", "recommendation", "project", "exam", "self_declaration", "other"], { message: "Type de preuve invalide" }),
  ...
  issuing_country: z.string().length(2, { message: "Le code pays doit contenir 2 caractères" }).optional(),
  credential_id: z.string().uuid({ message: "Identifiant du credential invalide" }).optional(),
...
export const UpdateSkillsExchangeSchema = z.object({
  ...
  evidence_type: z.enum(["certificate", "portfolio", "assessment", "recommendation", "project", "exam", "self_declaration", "other"], { message: "Type de preuve invalide" }).optional(),
  ...
  issuing_country: z.string().length(2, { message: "Le code pays doit contenir 2 caractères" }).optional().nullable(),
