...
import { certificateUpdateSchema } from '@/features/assessment/validators/assessment-certification';
...
export async function PUT(req: NextRequest, context: { params: { id: string } }) {
  try {
    ...
    const service = new AssessmentCertificateService(supabase);
    const data = await service.updateCertificate(schoolId, id, validation.data);
    return NextResponse.json(data);
  } catch (error) {
