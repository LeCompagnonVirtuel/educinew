...
export async function GET(
  ...
  try {
    ...
    if (error || !record) return NextResponse.json({ error: 'Compte introuvable' }, { status: 404 });
...
export async function PUT(
  ...
  try {
    ...
    if (data.accountIdentifier !== undefined) updateData.account_identifier = data.accountIdentifier;
