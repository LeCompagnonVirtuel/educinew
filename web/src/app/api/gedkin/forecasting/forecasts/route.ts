...
const CreateSchema = z.object({
  ...
  model_id: z.string().uuid('ID mod̬le invalide'),
  horizon: z.string().min(1, 'Horizon requis'),
  target_variable: z.string().min(1, 'Variable cible requise'),
