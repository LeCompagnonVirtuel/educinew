...
const UpdateSchema = z.object({
  ...
  category: z.enum(['ACADEMIC', 'FINANCIAL', 'OPERATIONAL', 'SOCIAL', 'ENVIRONMENTAL']).optional(),
...
export async function GET(
  ...
  try {
    ...
    if (error || !record) return NextResponse.json({ error: 'Indicateur introuvable' }, { status: 404 });
