...
const CreateSchema = z.object({
  ...
  category: z.enum(['ACADEMIC', 'FINANCIAL', 'OPERATIONAL', 'HR', 'TECHNOLOGY', 'SOCIAL']),
  scope: z.enum(['SCHOOL', 'DEPARTMENT', 'CLASS', 'ALL']),
  effective_date: z.string().min(1, 'Date effective requise'),
