...
const CreateSchema = z.object({
  ...
  type: z.enum(['DATA_SHARING', 'DATA_PROCESSING', 'DATA_LICENSE', 'SLA', 'PARTNERSHIP']),
  partner: z.string().min(1, 'Partenaire requis'),
  start_date: z.string().min(1, 'Date de d̩but requise'),
...
export async function GET(request: NextRequest) {
  try {
    ...
    const allowedRoles = ['SUPER_ADMIN', 'ADMIN', 'DIRECTEUR', 'COMPTABLE'];
