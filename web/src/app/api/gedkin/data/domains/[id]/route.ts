...
import { createClient } from '@/utils/supabase/server';
  ...
  type: z.enum(['ACADEMIC', 'ADMINISTRATIVE', 'FINANCIAL', 'OPERATIONAL', 'RESEARCH']).optional(),
...
export async function GET(
  ...
  try {
    ...
    if (error || !record) return NextResponse.json({ error: 'Domaine introuvable' }, { status: 404 });
