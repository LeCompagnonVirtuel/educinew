...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const data = await service.listAffiliateCommissions(schoolId, parentId);
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const service = new EntAffiliateCommissionService(supabase);
    const data = await service.createAffiliateCommission(body.schoolId, body.parentId, body);
