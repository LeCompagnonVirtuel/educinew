...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const data = await service.listLearningPathProgress(schoolId, parentId);
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const service = new EntLearningPathProgressService(supabase);
    const data = await service.createLearningPathProgress(body.schoolId, body.parentId, body);
