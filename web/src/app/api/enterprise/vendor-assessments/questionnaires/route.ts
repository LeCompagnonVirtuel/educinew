...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const data = await service.listVendorQuestionnaires(schoolId, parentId);
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const service = new EntVendorQuestionnaireService(supabase);
    const data = await service.createVendorQuestionnaire(body.schoolId, body.parentId, body);
