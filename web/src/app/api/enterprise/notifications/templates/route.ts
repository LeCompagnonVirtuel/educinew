...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const data = await service.listNotificationTemplates(schoolId, parentId);
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const service = new EntNotificationTemplateService(supabase);
    const data = await service.createNotificationTemplate(body.schoolId, body.parentId, body);
