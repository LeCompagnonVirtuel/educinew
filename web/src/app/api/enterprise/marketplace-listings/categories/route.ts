...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const data = await service.listMarketplaceCategories(schoolId, parentId);
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const service = new EntMarketplaceCategoryService(supabase);
    const data = await service.createMarketplaceCategory(body.schoolId, body.parentId, body);
