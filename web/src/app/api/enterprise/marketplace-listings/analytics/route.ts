...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const data = await service.listMarketplaceAnalytics(schoolId, parentId);
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const service = new EntMarketplaceAnalyticsService(supabase);
    const data = await service.createMarketplaceAnalytics(body.schoolId, body.parentId, body);
