...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const data = await service.listMonitoringResolutions(schoolId, parentId);
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const service = new EntMonitoringResolutionService(supabase);
    const data = await service.createMonitoringResolution(body.schoolId, body.parentId, body);
