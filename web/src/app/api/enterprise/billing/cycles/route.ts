...
import { createBillingService } from '@/features/enterprise/services/billing.service';
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const data = await service.getBillingCycles('');
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const service = createBillingService(repo);
    const body = await request.json();
    const data = await service.getBillingCycles('', body);
