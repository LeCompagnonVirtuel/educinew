...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const data = await service.listPostMortemActionItems(schoolId, parentId);
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const service = new EntPostMortemActionItemService(supabase);
    const data = await service.createPostMortemActionItem(body.schoolId, body.parentId, body);
