...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const data = await service.listStatusPageComponents(schoolId, parentId);
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const service = new EntStatusPageComponentService(supabase);
    const data = await service.createStatusPageComponent(body.schoolId, body.parentId, body);
