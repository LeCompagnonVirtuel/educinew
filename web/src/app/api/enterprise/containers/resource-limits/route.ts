...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const data = await service.listContainerResourceLimits(schoolId, parentId);
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const service = new EntContainerResourceLimitService(supabase);
    const data = await service.createContainerResourceLimit(body.schoolId, body.parentId, body);
