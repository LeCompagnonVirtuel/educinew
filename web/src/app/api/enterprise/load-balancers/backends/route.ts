...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const data = await service.listLoadBalancerBackends(schoolId, parentId);
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const service = new EntLoadBalancerBackendService(supabase);
    const data = await service.createLoadBalancerBackend(body.schoolId, body.parentId, body);
