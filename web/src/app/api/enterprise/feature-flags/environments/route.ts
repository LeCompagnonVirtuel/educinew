...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const data = await service.listFeatureFlagEnvironments(schoolId, parentId);
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const service = new EntFeatureFlagEnvironmentService(supabase);
    const data = await service.createFeatureFlagEnvironment(body.schoolId, body.parentId, body);
