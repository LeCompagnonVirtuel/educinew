...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const data = await service.listCapacityRecommendations(schoolId, parentId);
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const service = new EntCapacityRecommendationService(supabase);
    const data = await service.createCapacityRecommendation(body.schoolId, body.parentId, body);
