...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const data = await service.listPolicyAcknowledgments(schoolId, parentId);
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const service = new EntPolicyAcknowledgmentService(supabase);
    const data = await service.createPolicyAcknowledgment(body.schoolId, body.parentId, body);
