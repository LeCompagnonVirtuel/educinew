...
import { createApprovalService } from '@/features/integration/services/approval.service';
...
export async function POST(request: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    const data = await service.approveRequest(body.schoolId, body.userId, params.id, body.comment);
