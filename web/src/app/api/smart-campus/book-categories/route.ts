...
export async function GET(request: NextRequest) {
  try {
    ...
    const service = new ScBookCategoryService(supabaseService);
    const data = await service.listBookCategories(schoolId);
...
export async function POST(request: NextRequest) {
  try {
    ...
    const service = new ScBookCategoryService(supabaseService);
    const data = await service.createBookCategory(body.schoolId, body);
