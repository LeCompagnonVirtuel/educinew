...
import { createBroadcastSchema } from '@/features/messages/validators/schemas';
...
export async function POST(req: NextRequest) {
  try {
    ...
    const { title, content, scope, targetIds, channels, attachmentIds, scheduledAt } = validation.data;
