...
export const PATCH = withSupabase({ auth: 'user' }, async (req, ctx) => {
  ...
  if (data.sectionId !== undefined) updateData.section_id = data.sectionId || null;
  if (data.streamId !== undefined) updateData.stream_id = data.streamId || null;
  if (data.academicYearId !== undefined) updateData.academic_year_id = data.academicYearId || null;
  if (data.roomId !== undefined) updateData.room_id = data.roomId || null;
