...
import { AutomationRuleCreateSchema } from '@/features/aeip/validators/autonomous-ops-validators';
...
export async function GET(req: NextRequest) {
  try {
    ...
    const result = await service.findAll(schoolId, { page, limit, search, isActive });
