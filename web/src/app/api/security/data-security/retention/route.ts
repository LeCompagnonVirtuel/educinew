...
const ListRetentionPoliciesSchema = z.object({
...
const CreateRetentionPolicySchema = z.object({
  ...
  data_type: z.string().min(1, 'Type de donn̩es requis'),
...
export async function GET(request: NextRequest) {
  try {
    ...
    const validation = ListRetentionPoliciesSchema.safeParse(params);
