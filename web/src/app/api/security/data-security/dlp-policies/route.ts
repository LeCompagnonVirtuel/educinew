...
const CreatePolicySchema = z.object({
  ...
  type: z.enum(['CONTENT_INSPECTION', 'CONTEXTUAL', 'ENDPOINT', 'NETWORK', 'CLOUD']),
  rules: z.array(z.record(z.unknown())).min(1, 'R̬gles requises'),
  actions: z.array(z.enum(['BLOCK', 'ALERT', 'ENCRYPT', 'QUARANTINE', 'LOG'])),
...
export async function GET(request: NextRequest) {
  try {
    ...
    const validation = ListPoliciesSchema.safeParse(params);
