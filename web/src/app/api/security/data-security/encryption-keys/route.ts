...
const CreateKeySchema = z.object({
  ...
  algorithm: z.enum(['AES_256', 'RSA_2048', 'RSA_4096', 'ECDSA_P256', 'ECDSA_P384', 'CHACHA20']),
  purpose: z.enum(['ENCRYPTION', 'SIGNING', 'KEY_EXCHANGE', 'TLS', 'BACKUP']),
...
export async function GET(request: NextRequest) {
  try {
    ...
    const validation = ListKeysSchema.safeParse(params);
