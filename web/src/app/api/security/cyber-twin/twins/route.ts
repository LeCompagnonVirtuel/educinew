...
const ListTwinsSchema = z.object({
...
const CreateTwinSchema = z.object({
  ...
  type: z.enum(['NETWORK', 'APPLICATION', 'INFRASTRUCTURE', 'FULL_STACK']),
...
export async function GET(request: NextRequest) {
  try {
    ...
    const validation = ListTwinsSchema.safeParse(params);
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validation = CreateTwinSchema.safeParse(body);
    if (!validation.success) {
