...
const ListGovernanceSchema = z.object({
...
const CreateGovernanceSchema = z.object({
  name: z.string().min(1, 'Nom requis'),
  description: z.string().optional(),
  type: z.enum(['POLICY', 'PROCEDURE', 'GUIDELINE', 'STANDARD', 'REGULATION']),
...
export async function GET(request: NextRequest) {
  try {
    ...
    const validation = ListGovernanceSchema.safeParse(params);
