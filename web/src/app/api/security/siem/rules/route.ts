...
const CreateRuleSchema = z.object({
  ...
  conditions: z.array(z.record(z.unknown())).min(1, 'Conditions requises'),
  actions: z.array(z.record(z.unknown())).min(1, 'Actions requises'),
...
export async function GET(request: NextRequest) {
  try {
    ...
    const validation = ListRulesSchema.safeParse(params);
