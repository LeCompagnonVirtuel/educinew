...
const CreatePlanSchema = z.object({
  ...
  type: z.enum(['DISASTER_RECOVERY', 'BUSINESS_CONTINUITY', 'CRISIS_MANAGEMENT', 'COMMUNICATION']),
  scope: z.string().optional(),
  recovery_time_objective_hours: z.number().int().positive(),
  recovery_point_objective_hours: z.number().int().positive(),
...
export async function GET(request: NextRequest) {
  try {
    ...
    const validation = ListPlansSchema.safeParse(params);
