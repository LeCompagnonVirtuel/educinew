...
const CreateTestSchema = z.object({
  plan_id: z.string().uuid('ID de plan requis'),
  name: z.string().min(1, 'Nom requis'),
  description: z.string().optional(),
  test_type: z.enum(['TABLETOP', 'SIMULATION', 'FULL_EXERCISE', 'PARTIAL_EXERCISE']),
...
export async function GET(request: NextRequest) {
  try {
    ...
    const validation = ListTestsSchema.safeParse(params);
