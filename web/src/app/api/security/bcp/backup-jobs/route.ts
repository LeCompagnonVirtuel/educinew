...
const CreateJobSchema = z.object({
  policy_id: z.string().uuid('ID de politique requis'),
  override_targets: z.array(z.string()).optional(),
...
export async function GET(request: NextRequest) {
  try {
    ...
    const validation = ListJobsSchema.safeParse(params);
  ...
  try {
    ...
    const { data: job, error } = await supabase
      ...
      .insert({
        ...
        override_targets: data.override_targets || null,
