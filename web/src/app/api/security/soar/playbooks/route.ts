...
const ListPlaybooksSchema = z.object({
...
const CreatePlaybookSchema = z.object({
  ...
  trigger_type: z.enum(['MANUAL', 'EVENT', 'SCHEDULED', 'WEBHOOK']),
  steps: z.array(z.record(z.unknown())).min(1, 'Ã‰tapes requises'),
...
export async function GET(request: NextRequest) {
  try {
    ...
    const validation = ListPlaybooksSchema.safeParse(params);
