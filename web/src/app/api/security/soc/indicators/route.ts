...
const CreateIndicatorSchema = z.object({
  type: z.enum(['IP', 'DOMAIN', 'HASH', 'URL', 'EMAIL', 'OTHER']),
...
export async function GET(request: NextRequest) {
  try {
    ...
    const validation = ListIndicatorsSchema.safeParse(params);
    ...
    if (filters.confidence) query = query.gte('confidence', parseInt(filters.confidence));
