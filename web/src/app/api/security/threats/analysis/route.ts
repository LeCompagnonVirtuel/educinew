...
const CreateAnalysisSchema = z.object({
  ...
  type: z.enum(['INDICATOR_CORRELATION', 'BEHAVIORAL', 'PATTERN', 'ML_BASED']),
  indicators: z.array(z.string().uuid()).optional(),
...
export async function GET(request: NextRequest) {
  try {
    ...
    const validation = ListAnalysisSchema.safeParse(params);
