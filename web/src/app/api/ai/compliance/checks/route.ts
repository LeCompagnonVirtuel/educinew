...
import { complianceCheckcomplianceCheckSchema } from '@/features/ai/validators/complianceCheckSchemas';
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const data = await service.getChecks(schoolId);
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const service = new AiComplianceService(supabase);
    const data = await service.POST_getChecks(validated);
