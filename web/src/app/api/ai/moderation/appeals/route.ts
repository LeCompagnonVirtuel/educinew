...
import { appealappealSchema } from '@/features/ai/validators/appealSchemas';
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const data = await service.getAppeals(schoolId);
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const service = new AiModerationService(supabase);
    const data = await service.POST_getAppeals(validated);
