...
import { schedulescheduleSchema } from '@/features/ai/validators/scheduleSchemas';
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const data = await service.listSchedules(schoolId);
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const service = new AiScheduleService(supabase);
    const data = await service.POST_listSchedules(validated);
