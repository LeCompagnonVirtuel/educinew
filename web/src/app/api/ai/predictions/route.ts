...
import { predictionRequestpredictionRequestSchema } from '@/features/ai/validators/predictionRequestSchemas';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const service = new AiPredictionService(supabase);
    const data = await service.POST_getPredictions(validated);
