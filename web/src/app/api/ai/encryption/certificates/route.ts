...
import { certificatecertificateSchema } from '@/features/ai/validators/certificateSchemas';
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const data = await service.getCertificates(schoolId);
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const service = new AiEncryptionService(supabase);
    const data = await service.POST_getCertificates(validated);
