...
import { widgetwidgetSchema } from '@/features/ai/validators/widgetSchemas';
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const data = await service.getWidgets(schoolId);
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const service = new AiDashboardService(supabase);
    const data = await service.POST_getWidgets(validated);
