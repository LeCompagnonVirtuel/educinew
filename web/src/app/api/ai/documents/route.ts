...
import { documentUploaddocumentUploadSchema } from '@/features/ai/validators/documentUploadSchemas';
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const data = await service.listDocuments(schoolId);
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const service = new AiDocumentProcessingService(supabase);
    const data = await service.POST_listDocuments(validated);
