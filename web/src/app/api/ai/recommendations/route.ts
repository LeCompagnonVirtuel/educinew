...
import { recommendationRequestrecommendationRequestSchema } from '@/features/ai/validators/recommendationRequestSchemas';
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const data = await service.getRecommendations(schoolId);
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const service = new AiRecommendationService(supabase);
    const data = await service.POST_getRecommendations(validated);
