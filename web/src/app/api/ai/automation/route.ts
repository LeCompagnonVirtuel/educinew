...
import { automationWorkflowautomationWorkflowSchema } from '@/features/ai/validators/automationWorkflowSchemas';
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const data = await service.listWorkflows(schoolId);
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const validated = automationWorkflowSchema.parse(body);
    const service = new AiAutomationService(supabase);
    const data = await service.POST_listWorkflows(validated);
