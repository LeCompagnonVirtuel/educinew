...
import { automationWebhookautomationWebhookSchema } from '@/features/ai/validators/automationWebhookSchemas';
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const validated = automationWebhookSchema.parse(body);
    const service = new AiAutomationService(supabase);
