...
import { ArchiveStudentSchema } from '@/features/students/validators';
...
export const POST = withSupabase({ auth: 'user' }, async (req, ctx) => {
  ...
  const validation = ArchiveStudentSchema.safeParse({ ...body, studentId: id });
