...
import { reportCardSchema } from '@/features/exams/validators/schemas';
...
export async function POST(req: NextRequest) {
  try {
    ...
    const validation = reportCardSchema.safeParse({ ...body, schoolId });
    ...
    logger.error('Error creating report card', error);
    return NextResponse.json({ error: 'Erreur interne' }, { status: 500 });
  }
}
