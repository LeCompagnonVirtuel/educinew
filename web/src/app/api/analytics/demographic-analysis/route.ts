...
import { createDemographicAnalysisService } from '@/features/analytics/services/demographic-analysis.service';
...
export async function GET(request: NextRequest) {
  try {
    ...
    const service = createDemographicAnalysisService(repo);
