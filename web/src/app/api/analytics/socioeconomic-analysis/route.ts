...
import { createSocioeconomicAnalysisService } from '@/features/analytics/services/socioeconomic-analysis.service';
...
export async function GET(request: NextRequest) {
  try {
    ...
    const service = createSocioeconomicAnalysisService(repo);
