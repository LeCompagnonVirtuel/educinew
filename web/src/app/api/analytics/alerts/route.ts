...
import { createAlertsService } from '@/features/analytics/services/alerts.service';
...
export async function GET(request: NextRequest) {
  try {
    ...
    const data = await service.getAlertHistory(params);
...
export async function POST(request: NextRequest) {
  try {
    ...
    const data = await service.sendAlert(body);
