...
import { createEducationLevelAnalysisService } from '@/features/analytics/services/education-level-analysis.service';
...
export async function GET(request: NextRequest) {
  try {
    ...
    const service = createEducationLevelAnalysisService(repo);
