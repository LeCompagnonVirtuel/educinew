...
import { createUrbanRuralAnalysisService } from '@/features/analytics/services/urban-rural-analysis.service';
...
export async function GET(request: NextRequest) {
  try {
    ...
    const service = createUrbanRuralAnalysisService(repo);
