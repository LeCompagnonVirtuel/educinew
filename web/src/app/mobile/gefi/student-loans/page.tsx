...
export default function StudentLoansPage() {
  ...
  const stats = [
    { label: 'Prets actifs', value: '34' },
    { label: 'Montant total', value: '4 500 000 FCFA' },
    { label: 'Remboursements en cours', value: '28' },
    { label: 'Taux remboursement', value: '76%' },
  ];

  const entities = [
    { id: 1, name: 'Prets academiques', description: 'Financement etudes' },
    { id: 2, name: 'Prets sociaux', description: 'Aide d\'urgence' },
    { id: 3, name: 'Echeanciers', description: 'Plans de remboursement' },
    { id: 4, name: 'Garants', description: 'Cautionneurs' },
    { id: 5, name: 'Impayes', description: 'Retards de paiement' },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-xl font-bold text-gray-900">Prets etudiants</h1>
        <button
