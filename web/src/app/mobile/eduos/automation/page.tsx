...
const ENTITIES = [
  { id: '1', name: 'AutomationBuilder', description: 'Visual workflow automation designer', status: 'active', count: 56 },
  { id: '2', name: 'EventTrigger', description: 'Event-driven automation trigger system', status: 'active', count: 124 },
  { id: '3', name: 'CronJob', description: 'Scheduled task execution engine', status: 'running', count: 38 },
];
  ...
  return (
    <div className="flex-1 bg-gray-50 min-h-screen">
      <div className="px-4 pt-4 pb-3">
        ...
        <p className="text-sm text-gray-500 mt-1">AutomationBuilder · EventTrigger · CronJob</p>
      </div>
      <div className="flex mx-4 mb-4 bg-white rounded-xl p-4 shadow-sm">
        <div className="flex-1 text-center">
          ...
          <div className="text-xs text-gray-500 mt-1">Workflows</div>
        </div>
        <div className="flex-1 text-center">
        ...
        <div className="flex-1 text-center">
          ...
          <div className="text-xs text-gray-500 mt-1">Cron Jobs</div>
        </div>
      </div>
