...
export default function CooperationPage() {
  const [stats] = useState({
    partnerCountries: 28,
    activeProjects: 45,
    fundingReceived: '120M',
    exchangeStudents: 3200,
    jointResearch: 89,
    bilateralAgreements: 34,
  });
  ...
  const entities = [
    { name: 'Partner Organizations', count: 64, icon: '🤝' },
    { name: 'Active Projects', count: stats.activeProjects, icon: '📋' },
    { name: 'Exchange Programs', count: 18, icon: '🌐' },
    { name: 'Bilateral Agreements', count: stats.bilateralAgreements, icon: '📜' },
    { name: 'International Schools', count: 120, icon: '🏫' },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-xl font-bold text-gray-900">International Cooperation</h1>
          <p className="text-sm text-gray-500">Global Education Partnerships</p>
        </div>
        <button
