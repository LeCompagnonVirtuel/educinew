...
export default function PortalPage() {
  ...
  const entities = [
    { name: 'Student Services', count: 18, icon: '🎓' },
    { name: 'Parent Services', count: 12, icon: '👨‍👩‍👧' },
    { name: 'Teacher Services', count: 14, icon: '👩‍🏫' },
    { name: 'Administrative Services', count: 10, icon: '⚙️' },
    { name: 'Payment Services', count: 10, icon: '💳' },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-xl font-bold text-gray-900">Public Services Portal</h1>
          <p className="text-sm text-gray-500">Unified Education Service Gateway</p>
        </div>
        <button
