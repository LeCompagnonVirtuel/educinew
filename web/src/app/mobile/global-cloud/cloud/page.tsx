...
export default function GlobalCloudPage() {
  ...
  const stats = [
    { label: 'Connected Schools', value: '1,247' },
    { label: 'Active Users', value: '89,432' },
    { label: 'Data Synced', value: '12.4 TB' },
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-xl font-bold text-gray-900">Global Education Cloud</h1>
        <button
