...
export default function GovernmentPage() {
  const { data, loading, error, refresh } = useMobileApi<GovernmentItem>({
    endpoint: '/api/global-cloud/government',
    transform: (items) =>
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-xl font-bold text-gray-900">Government Intelligence</h1>
        <button
          onClick={() => refresh()}
          disabled={loading}
