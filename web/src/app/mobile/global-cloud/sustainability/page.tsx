...
export default function SustainabilityPage() {
  ...
  const stats = [
    { label: 'Carbon Offset', value: '1,247 t' },
    { label: 'Energy Saved', value: '342 MWh' },
    { label: 'Water Reduced', value: '89,000 L' },
    { label: 'SDG Progress', value: '78%' },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-xl font-bold text-gray-900">Sustainability Platform</h1>
        <button
