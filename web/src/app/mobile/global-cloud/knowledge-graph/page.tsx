...
export default function KnowledgeGraphPage() {
  ...
  const stats = [
    { label: 'Knowledge Nodes', value: '14.2M' },
    { label: 'Relationships', value: '89.4M' },
    { label: 'Insights Generated', value: '3,241' },
    { label: 'Query Accuracy', value: '94.7%' },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-xl font-bold text-gray-900">Education Knowledge Graph</h1>
        <button
