...
const FALLBACK_RESOURCES: Resource[] = [
  { id: '1', name: 'Classroom A1', type: 'SPACE', utilization: 87, capacity: 40, status: 'optimal' },
  { id: '2', name: 'Computer Lab', type: 'TECHNOLOGY', utilization: 95, capacity: 30, status: 'overutilized' },
  { id: '3', name: 'Library Hall', type: 'SPACE', utilization: 52, capacity: 100, status: 'underutilized' },
  { id: '4', name: 'Teaching Staff', type: 'HUMAN', utilization: 78, capacity: 45, status: 'optimal' },
  { id: '5', name: 'Transport Fleet', type: 'VEHICLE', utilization: 63, capacity: 8, status: 'underutilized' },
  { id: '6', name: 'Science Lab', type: 'SPACE', utilization: 91, capacity: 25, status: 'overutilized' },
];
