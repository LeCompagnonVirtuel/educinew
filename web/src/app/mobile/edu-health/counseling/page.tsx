...
export default function CounselingPage() {
  ...
  const entities = [
    { name: 'Total Sessions', count: stats.totalSessions, icon: '💬' },
    { name: 'Completed', count: stats.completedSessions, icon: '✅' },
    { name: 'Upcoming', count: stats.upcomingSessions, icon: '📅' },
    { name: 'Active Cases', count: stats.activeCases, icon: '📋' },
    { name: 'Counselors', count: stats.counselorsAvailable, icon: '🧑‍⚕️' },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-xl font-bold text-gray-900">Counseling</h1>
          <p className="text-sm text-gray-500">Counseling Services</p>
        </div>
        <button
