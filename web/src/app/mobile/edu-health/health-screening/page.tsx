...
export default function HealthScreeningPage() {
  const [stats] = useState({
    totalScreenings: 1200,
    completedScreenings: 980,
    pendingScreenings: 220,
    visionIssues: 65,
    hearingIssues: 30,
    referralsMade: 48,
  });
  ...
  const entities = [
    { name: 'Total Screenings', count: stats.totalScreenings, icon: '🔍' },
    { name: 'Completed', count: stats.completedScreenings, icon: '✅' },
    { name: 'Pending', count: stats.pendingScreenings, icon: '⏳' },
    { name: 'Vision Issues', count: stats.visionIssues, icon: '👁️' },
    { name: 'Hearing Issues', count: stats.hearingIssues, icon: '👂' },
  ];
    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500">Screening & Diagnostics</p>
        </div>
        <button
