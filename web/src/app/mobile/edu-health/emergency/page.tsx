...
export default function EmergencyPage() {
  ...
  const entities = [
    { name: 'Active Alerts', count: stats.activeAlerts, icon: '🚨' },
    { name: 'Response Teams', count: stats.responseTeams, icon: '🚒' },
    { name: 'Emergency Contacts', count: stats.emergencyContacts, icon: '📞' },
    { name: 'Safety Protocols', count: 25, icon: '📋' },
    { name: 'Incident Reports', count: stats.incidentsReported, icon: '📄' },
  ];
    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500">Crisis Response & Safety</p>
        </div>
        <button
