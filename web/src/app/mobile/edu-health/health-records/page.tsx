...
export default function HealthRecordsPage() {
  const [stats] = useState({
    totalRecords: 1250,
    completeRecords: 1100,
    incompleteRecords: 150,
    allergiesReported: 85,
    chronicConditions: 42,
    emergencyContacts: 1200,
  });
  ...
  const entities = [
    { name: 'Total Records', count: stats.totalRecords, icon: '📁' },
    { name: 'Complete Records', count: stats.completeRecords, icon: '✅' },
    { name: 'Incomplete Records', count: stats.incompleteRecords, icon: '⚠️' },
    { name: 'Allergies Reported', count: stats.allergiesReported, icon: '🤧' },
    { name: 'Chronic Conditions', count: stats.chronicConditions, icon: '🏥' },
  ];
    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500">Student Health Information</p>
        </div>
        <button
