...
export default function SafetyPage() {
  ...
  const entities = [
    { name: 'Total Inspections', count: stats.totalInspections, icon: '🔍' },
    { name: 'Completed', count: stats.completedInspections, icon: '✅' },
    { name: 'Pending', count: stats.pendingInspections, icon: '⏳' },
    { name: 'Hazards Identified', count: stats.hazardsIdentified, icon: '⚠️' },
    { name: 'Safety Score', count: stats.safetyScore, icon: '🛡️' },
  ];
    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500">School Safety Management</p>
        </div>
        <button
