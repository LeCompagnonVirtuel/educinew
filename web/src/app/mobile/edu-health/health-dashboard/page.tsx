...
export default function HealthDashboardPage() {
  ...
  const entities = [
    ...
    { name: 'Healthy Students', count: stats.healthyStudents, icon: '✅' },
    { name: 'Pending Checkups', count: stats.pendingCheckups, icon: '🏥' },
    { name: 'Immunized', count: stats.immunizedStudents, icon: '💉' },
    { name: 'Health Alerts', count: stats.healthAlerts, icon: '🚨' },
  ];
    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500">EduHealth Overview</p>
        </div>
        <button
