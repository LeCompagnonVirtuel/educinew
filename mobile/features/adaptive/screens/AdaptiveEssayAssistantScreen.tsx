...
export default function AdaptiveEssayAssistantScreen({ navigation }: any) {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      console.error('[AdaptiveEssayAssistantScreen]', err);
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Essay Assistant</Text>
        <TouchableOpacity>
