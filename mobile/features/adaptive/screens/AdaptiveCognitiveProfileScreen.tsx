...
export default function AdaptiveCognitiveProfileScreen({ navigation }: any) {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      console.error('[AdaptiveCognitiveProfileScreen]', err);
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Cognitive Profile</Text>
        <TouchableOpacity>
