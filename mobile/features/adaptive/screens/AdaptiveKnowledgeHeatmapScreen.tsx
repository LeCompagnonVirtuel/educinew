...
export default function AdaptiveKnowledgeHeatmapScreen({ navigation }: any) {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      console.error('[AdaptiveKnowledgeHeatmapScreen]', err);
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Knowledge Heatmap</Text>
        <TouchableOpacity>
