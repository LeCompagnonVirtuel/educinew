...
export default function AdaptiveRecommendedVideoScreen({ navigation }: any) {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      console.error('[AdaptiveRecommendedVideoScreen]', err);
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Recommended Video</Text>
        <TouchableOpacity>
