...
export default function AdaptiveSkillEvolutionScreen({ navigation }: any) {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      console.error('[AdaptiveSkillEvolutionScreen]', err);
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Skill Evolution</Text>
        <TouchableOpacity>
