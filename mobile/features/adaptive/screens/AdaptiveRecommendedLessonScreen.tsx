...
export default function AdaptiveRecommendedLessonScreen({ navigation }: any) {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      console.error('[AdaptiveRecommendedLessonScreen]', err);
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Recommended Lesson</Text>
        <TouchableOpacity>
