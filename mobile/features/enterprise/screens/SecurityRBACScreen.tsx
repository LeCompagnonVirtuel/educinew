...
export const SecurityRBACScreen: React.FC<{ navigation: any }> = ({ navigation }) => {
  ...
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.title}>Contrôle d'accès basé sur les rôles</Text>
      {items.map((item) => (
        <TouchableOpacity key={item.id} style={styles.card}
          onPress={() => navigation.navigate('SecurityRBACScreenDetail', { id: item.id })}>
