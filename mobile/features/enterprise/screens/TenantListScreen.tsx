...
export const TenantListScreen: React.FC<{ navigation: any }> = ({ navigation }) => {
  ...
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.title}>Liste des locataires</Text>
      {items.map((item) => (
        <TouchableOpacity key={item.id} style={styles.card}
          onPress={() => navigation.navigate('TenantListScreenDetail', { id: item.id })}>
