...
const teacherTabs: TabItem[] = [
  { name: 'dashboard', icon: 'grid-outline', iconFilled: 'grid', label: 'Accueil' },
  { name: 'classes', icon: 'school-outline', iconFilled: 'school', label: 'Classes' },
  { name: 'attendance', icon: 'checkmark-done-outline', iconFilled: 'checkmark-done', label: 'Présences' },
...
export function TeacherTabBar({ activeTab, onTabPress }: TeacherTabBarProps) {
