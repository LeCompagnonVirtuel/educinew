-- =====================================================
-- CRITICAL: Fix register_school_via_activation
-- 1. Add missing subscription + academic year creation
-- 2. Add status column to users insert
-- 3. Ensure parity with register_school_with_admin
-- =====================================================
