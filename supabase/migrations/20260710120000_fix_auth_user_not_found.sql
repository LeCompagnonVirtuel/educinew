-- Migration: Fix enterprise_activate_school to handle missing auth user
-- If the auth user doesn't exist (was deleted or ID mismatch), create it
  ...
  BEGIN
    ...
    ELSE
      ...
      IF v_user_id IS NOT NULL THEN
        ...
        WHERE id = v_user_id;
      ELSE
        -- No user found at all, create one
        ...
        -- Update draft with the correct auth_user_id
    ...
    -- 3. Create school (ALL user fields from wizard, including logo_url)
    INSERT INTO schools (
