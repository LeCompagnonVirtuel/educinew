-- Migration: Fix enterprise_activate_school to copy logo_url to schools table
-- This ensures the logo is available in both schools and school_branding tables
...
BEGIN
  ...
  BEGIN
    ...
    -- 8. Create branding (using CORRECT column names)
